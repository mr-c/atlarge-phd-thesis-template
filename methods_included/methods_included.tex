...
\begin{table}
  ...
  \label{tab:runners}
    \begin{tabular}{ll}
      ...
      & or LSF\\
      \href{https://pypi.org/project/toil-cwl-runner}{Toil}\cite{vivian2017toil} & AWS, Azure, GCP, Grid Engine, HTCondor, \\
