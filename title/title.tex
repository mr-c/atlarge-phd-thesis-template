...
op 1 januari 1970 om 00:00 uur
...
\medskip\noindent
\begin{tabular}{l}
    promotor: Prof. dr.\ ir.\ A.\ Iosup\\
    copromotor: Dr.\ ir.\ A.\ U{\c t}a
\end{tabular}
...
\begin{tabular}{@{}p{0.2\textwidth}@{}p{0.8\textwidth}}
  \textit{Keywords:} &  \\[\medskipamount]
      ...
      \textit{Style:} & Atlarge House Style, based on the TU Delft House Style with modifications by Moritz Beller and Laurens Versluis \\& \url{https://github.com/lfdversluis/atlarge-phd-thesis-template} \\[\medskipamount]
\end{tabular}
