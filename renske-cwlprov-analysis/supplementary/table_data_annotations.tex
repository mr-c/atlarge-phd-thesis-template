\begin{table}[bt!]
\caption{Schema.org terms to use to express the metadata elements described in \ref{renske:tax:data}. Taken from Bioschemas Dataset profile v1.0.}\label{tab:renske:dataset_bioschemas}
