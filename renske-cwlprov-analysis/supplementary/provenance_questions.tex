\section{Provenance questions}\label{renske:sup:provquestions}
...
\subsection*{\ref{renske:uc:wf_dev}: Workflow development}
...
\subsection{\ref{renske:uc:writing}: Publishing the workflow}
...
\subsection{\ref{renske:uc:understanding}: Understanding the workflow}
\begin{provquestions}[resume]
...
\subsection{\ref{renske:uc:reproducing}: Reproducing the workflow}
...
\subsection{\ref{renske:uc:service}: Model as a web service}
