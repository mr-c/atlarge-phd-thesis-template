...
\label{sec:renske:wf_requirements}
...
\begin{enumerate}[label=\textbf{WR\arabic*}]
    \item \label{renske:wr:method} Adhere to a specific method of epitope prediction which was conceptualized and provided to us by the workflow authors.
    \item \label{renske:wr:reproducibility} Address challenges which compromise the transparency and reproducibility of the workflow.
\end{enumerate}


\subsection{\ref{renske:wr:method}: Adhere to a conceptual method}
\label{sec:renske:wf_design}

In this section, we explain \ref{renske:wr:method}, providing a conceptual overview of the method which should be implemented in the CWL workflow we used as an exemplary workflow in this work.
...
\subsection{\ref{renske:wr:reproducibility}: Address reproducibility challenges for this workflow}
\label{sec:renske:wf_reproducibility}

In this section, we explain \ref{renske:wr:reproducibility} by presenting a number of characteristics of our workflow which may make its implementation challenging from a transparency and reproducibility perspective.
...
\label{sec:renske:wf_implementation}

In this section, we describe how we implemented the epitope prediction workflow in CWL, considering the requirements described in the previous sections. Figure \ref{fig:renske:wf} shows an overview of the CWL implementation of the workflow.

\subsubsection{Implementation of the conceptual method (\ref{renske:wr:method})}
...
\subsubsection{Consideration of workflow reproducibility  (\ref{renske:wr:reproducibility})} 
